...
static void TestBlockSubsidyHalvings(const Consensus::Params& consensusParams)
{
    ...
    //     if (nHalvings < 13) {
    //         // Boxycoin: nSubidy is held for block halvings 3-5 and block time increased for MIP3-longblocks
...
/* Boxycoin: we don't test other intervals due to MIP3-longblocks
...
BOOST_AUTO_TEST_CASE(subsidy_limit_test)
{
    // const auto chainParams = CreateChainParams(CBaseChainParams::MAIN);
    // CAmount nSum = 0;
    // // Boxycoin: step must be integer factor of our MIP3 120960 halving intervals, all interval steps are divisible by 945
