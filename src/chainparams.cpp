 ...
 *   vMerkleTree: 4a5e1e
 */
static CBlock CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, const char* pszTimestamp="On 01/24/2021 Boxycoin was reborn.")
{
    ...
    return CreateGenesisBlock(pszTimestamp, genesisOutputScript, nTime, nNonce, nBits, 1, 0);
}
...
public:
    CMainParams() {
        ...
        /*** Boxycoin Additional Chainparams ***/
        ...
        vSeeds.push_back("144.126.212.247");
        vSeeds.push_back("144.126.212.18");
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1611531850, 1369730, 0x1e0fffff, "On 01/24/2021 Boxycoin was reborn");
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0000023753ed822b48e50afef2797b33a3fa9194f9eb28da09ecf5b7101f964e"));
        assert(genesis.hashMerkleRoot == uint256S("c682ddc329dd86f5f199514c456897267fa95c83194cf4d4a18a609c1a9ef6ee"));
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1543452687, 0, 0x207fffff, "On 11/28/2018 the Boxycoin Regtest Genesis was created");
        consensus.hashGenesisBlock = genesis.GetHash();
