...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s boxycoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  boxycoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded boxycoin transaction") + "\n" +
              "  boxycoin-tx [options] -create [commands]   " + _("Create hex-encoded boxycoin transaction") + "\n" +
              "\n";
