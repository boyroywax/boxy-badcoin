...
{
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Boxycoin
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Boxycoin
    // Mac: ~/Library/Application Support/Boxycoin
    // Unix: ~/.boxycoin
#ifdef WIN32
    // Windows
...
void ArgsManager::ReadConfigFile(const std::string& confPath)
{
    ...
    if (!streamConfig.good())
        return; // No boxycoin.conf file is OK
